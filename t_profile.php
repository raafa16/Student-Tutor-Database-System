...
$sql = "SELECT User_ID FROM users_teacher WHERE Username = '$username' ";
...
while($row1 = mysql_fetch_array( $id1 ))
{
    ...
    $sql3 = "SELECT * FROM degree WHERE User_ID = $userid ";
    ...
    $sql4 = "SELECT * FROM region_covered_teacher WHERE User_ID = $userid ";
    ...
    salary_type FROM teacher_student_track WHERE User_ID_T = $userid ";
...
<div class="bottomcorner" id="profile">
    <div id="login_form">
    <form action="stlist.php" method="post">
        <h5>
            Search for prospective students:
        </h5>
...
<div class="middlecorner" id="profile">
    ...
    $sql8 = "SELECT COUNT(User_ID_ST) FROM survey WHERE User_ID_T = $userid";
    ...
    $sql9 = "SELECT COUNT(q1_yes_no) FROM survey WHERE User_ID_T = $userid AND q1_yes_no = 'Yes' ";
    ...
    $sql10 = "SELECT COUNT(q2_yes_no) FROM survey WHERE User_ID_T = $userid AND q2_yes_no = 'Yes' ";
    ...
    $sql11 = "SELECT COUNT(q3_yes_no) FROM survey WHERE User_ID_T = $userid AND q3_yes_no = 'Yes' ";
    ...
    $sql12 = "SELECT COUNT(q4_yes_no) FROM survey WHERE User_ID_T = $userid AND q4_yes_no = 'Yes' ";
    ...
    include('F:\Raafa\CSE331L Project Database\PhpstormProjects\sample_php\libchart\libchart\classes\libchart.php');
    ...
    $chart->setTitle("Teacher Ratings");
